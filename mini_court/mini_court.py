...
from utils import (convert_meters_to_pixel_distance, convert_pixel_distance_to_meters,
                   ...
                   measure_xy_distance, get_center_of_bbox, measure_distance
                   )
...
class MiniCourt():
    ...
    def set_mini_court_position(self):
        ...
        self.court_end_x = self.end_x - self.padding_court - safety_margin
    ...
    def draw_background_rectangle(self, frame):
        ...
        cv2.rectangle(shapes, (self.start_x, self.start_y), (self.end_x, self.end_y), (255, 255, 255), -1) # 255 is white BGR.
        out = frame.copy()
        alpha = 0.5
    ...
    def get_mini_court_coordinates(self, object_position, closest_key_point, 
                                   closest_key_point_index, player_height_in_pixels,
    ...
    def convert_bounding_boxes_to_mini_court_coordinates(self, player_boxes, ball_boxes, original_court_key_points):
        ...
        for frame_num, player_bbox in enumerate(player_boxes):
            ...
            for player_id, bbox in player_bbox.items():
               ...
               # Measuring closest keypoint in pixels:
               ...
               if closest_player_id_to_ball == player_id:
                  ...
                  mini_court_player_position = self.get_mini_court_coordinates(ball_position, closest_key_point,
                                                                            closest_key_point_index, max_player_height_in_pixels,
                                                                            player_heights[player_id])
